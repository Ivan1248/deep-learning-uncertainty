...
\subsubsection{Eksplicitno modeliranje aleatorne nesigurnosti}
...
\citet{Kendall:2017:WUNBDLCV} empirijski pokazuju da se uz modeliranje aleatorne nesigurnosti uz gubitke u jednadžbama~\eqref{eq:aleatorni-gubitak-regresija}~i~\eqref{eq:aleatorni-gubitak-klasifikacija} može dobiti malo poboljšanje predikcija na zadacima regresije dubine i semantičke segmentacije.

\subsubsection{Međusobna informacija}
...
razlikovanje nesigurnosti kao u \cite{Smith:2018:UMUAED}

ladder densenet, usporedba pogreške s vanillom
...
WRN-28-10, DensenetBC-100-12

od \citet{Hendrycks:2016:BDMOODE} do \cite{Liang:2017:PDOODENN} + logiti
