...
\centering
\begin{tikzpicture}
	\def\inp{\underline{\vec x}}
	\node[nrect] (x) {$\vec x$};
	\node[above=0 of x] {$\vec x$};
	\node[nrect] (h1a) [right=of x] {$\mat W_1\inp+\vec b_1$};
	\node[nrect] (h1f) [right=of h1a] {$f$};
	\node[above=0 of h1f] {$\vec h_1$};
	\node[nrect] (h2a) [right=of h1f] {$\mat W_2\inp+\vec b_2$};
	\node[nrect] (h2f) [right=of h2a] {$f$};
	\node[above=0 of h2f] {$\vec h_2$};
	\node[nrect] (oa) [right=of h2f] {$\mat W_3\inp+\vec b_3$};
	\node[nrect] (y) [right=of oa] {$f$};
	\node[above=0 of y] {$\vec y=h(\vec x)$};
