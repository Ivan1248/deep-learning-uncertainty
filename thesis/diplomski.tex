...
\begin{table}
	...
	\begin{tabular}{llrrrr}
		...
		\midrule
		CamVid-tv  & Cityscapes     &      -  & $0.383$ & $0.060$ & $0.1558$ \\
		CamVid-tv  & WildDash-bench &      -  & $0.501$ & $0.075$ & $0.1492$ \\
		\bottomrule
	\end{tabular}
	\caption{Procjene aleatorne i epistemičke nesigurnosti za različite parove skupa za učenje i skupa za ispitivanje. CamVid-tv označava uniju skupa za učenje i skupa za validaciju, $\text{CamVid-tv}/n$ skup koji ima $1/n$ od primjera skupa CamVid-tv, CamVid-val skup za validaciju koji je podskup skupa CamVid-tv, CamVid-test skup za testiranje, Cityscapes skup za testiranje Cityscapesa, WildDash-bench skup na kojemu bi trebala biti veća epistemička nesigurnost jer su slike raznolikije.}
