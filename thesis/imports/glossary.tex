...
\glsentm{vi}{distr}{\distrib{A},\,p,\,q}{Razdioba ili funkcija gustoće vjerojatnosti}
...
\glsentm{vi}{pmf}{P_{\rvar a}(a),\,P(a)} {Funkcija vjerojatnosti slučajne varijable $\rvar a$: $P_{\rvar a}(a)=\P(\rvar a= a)$}
\glsentm{vi}{probdens}{\p(\rvar a= a)} {Gustoća vjerojatnosti događaja $\rvar a=a$}
\glsentm{vi}{pdf}{p_{\rvar a}(a),\,p(a)} {Funkcija gustoće vjerojatosti slučajne varijable $\rvar a$}
\glsentm{vi}{pdfcond}{p_{\rvar a\mid b}(a),\,p(a\mid b)} {Gustoća vjerojatnosti za događaj $\cbr{\rvar a= a\mid\rvar b= b}$; $p_{\rvar a\mid b}(a)=\p(\rvar a= a\mid\rvar b= b)$}
\glsentm{vi}{pdfjoint}{p_{\rvar a,\rvar b}(a,b),\,p(a,b)} {Gustoća vjerojatnosti za događaj $\cbr{\rvar a= a,\rvar b= b}$; $p_{\rvar a,\rvar b}(a,b)=\p(\rvar a= a,\rvar b= b)$}
