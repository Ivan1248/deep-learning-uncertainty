...
from .data import datasets, OldDataset, MiniBatchReader, tfrecords
from . import dirs
...
class DatasetLoader:
    ...
    def load(self, subset='all', normalize=False, **kwargs):
        ...
        def normalize_dataset(ds):
            ...
            return OldDataset(images, ds.labels, ds.class_count)
...
ICCV09Loader = DatasetLoader(
    ...
    loader=lambda data_path, subset: datasets.load_iccv09(data_path),
    subsets=['all'],
