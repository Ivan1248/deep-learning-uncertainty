...
ds_train, ds_val = data_utils.get_cached_dataset_with_normalized_inputs(args.ds, trainval_test=False)
ds_trainval, ds_test = data_utils.get_cached_dataset_with_normalized_inputs(args.ds, trainval_test=True)
ds = {
    'train': ds_train,
    'val': ds_val,
...
view_semantic_segmentation(ds, infer=lambda x: ds[0][1])